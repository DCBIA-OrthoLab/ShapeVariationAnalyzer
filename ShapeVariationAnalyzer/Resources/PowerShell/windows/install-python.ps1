...
if (![System.IO.File]::Exists(".\install-utils.ps1")) {
  ...
  $url = "https://raw.githubusercontent.com/DCBIA-OrthoLab/ShapeVariationAnalyzer/release/ShapeVariationAnalyzer/Resources/PowerShell/windows/install-utils.ps1"
