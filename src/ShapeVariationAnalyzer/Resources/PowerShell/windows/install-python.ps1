...
if (![System.IO.File]::Exists(".\install-utils.ps1")) {
  ...
  $url = "$url = "https://raw.githubusercontent.com/pdedumast/ShapeVariationAnalyzer/master/src/ShapeVariationAnalyzer/Resources/PowerShell/windows/install-utils.ps1"
